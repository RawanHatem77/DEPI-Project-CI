    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "", "المنيل، القاهرة", "مستشفى قصر العيني" },
                    { 2, "", "المعادي، القاهرة", "مستشفى السلام الدولي" },
                    { 3, "", "العباسية، القاهرة", "مستشفى عين شمس التخصصي" },
                    { 4, "", "مصر الجديدة، القاهرة", "مستشفى كليوباترا" },
                    { 5, "", "كورنيش النيل، القاهرة", "مستشفى معهد ناصر" },
                    { 6, "", "طريق النصر، مدينة نصر", "مستشفى دار الفؤاد" },
                    { 7, "", "التجمع الخامس، القاهرة", "المستشفى الجوي التخصصي" }
                });

            migrationBuilder.InsertData(
                table: "Medicines",
                columns: new[] { "Id", "ActiveIngredient", "Description", "Name", "Quantity" },
                values: new object[,]
                {
                    { 1, "", "سكر نوع أول", "الأنسولين (ميكسيتارد)", 0 },
                    { 2, "", "أنسولين طويل المفعول", "لانتوس سولستار", 0 },
                    { 3, "", "سكر نوع ثاني", "سيدوفاج (ميتفورمين)", 0 },
                    { 4, "", "منظم سكر مركب", "جالفس مت", 0 },
                    { 5, "", "سيولة الدم - مرضى القلب", "بلافيكس", 0 },
                    { 6, "", "حماية المعدة", "كونترولوك", 0 },
                    { 7, "", "ضغط عالي وقلب", "كونكور", 0 },
                    { 8, "", "ضغط دم مرتفع", "إيراستابكس", 0 },
                    { 9, "", "ضغط دم منخفض", "كوراسور", 0 },
                    { 10, "", "ضغط دم منخفض", "ميدودرين", 0 },
                    { 11, "", "روماتيزم ومناعة", "ميثوتريكسيت حقن", 0 }
                });
